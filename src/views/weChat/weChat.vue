	...
	export default{
		...
		data(){
			return{
				//首页图片地址
				pcHome:[
					"../../../static/images/weChat/weChat1.png",
					"../../../static/images/weChat/weChat2.png",
					"../../../static/images/weChat/weChat3.png",
					"../../../static/images/weChat/weChat4.png",
					"../../../static/images/weChat/weChat5.png",
					"../../../static/images/weChat/weChat6.png",
